...
export const saleTweetMessages = [
  'Amazonの注文履歴から、今年買ったものの中でセール品だけを買い足すと、お得にストックできて節約になります🉐',
  'Amazonの注文履歴から、今年よく買った日用品をセール中にまとめて補充しておくと、かなり家計がラクになります🉐',
  '1年で最も安くなるから、ブラックフライデーだけは買っちゃいます😅\n\nAmazonブラックフライデーセール開催中です！',
...
// すべて「セールは12/1(月)まで〜」の形式で、短く意味が伝わるフレーズにする
export const saleTweetPrefixVariations = [
  'セールは12/1(月)まで⏰買い物チャンス💻',
  'セールは12/1(月)まで📚まとめ買いの好機📘',
  'セールは12/1(月)まで🛠️買うなら今✨',
  'セールは12/1(月)まで💡絶好のタイミング📈',
  'セールは12/1(月)まで🧠買い物期間🌱',
  'セールは12/1(月)まで🖥️仕事道具をグレードアップする！🚀',
  'セールは12/1(月)まで📖お得に買い物😇',
  'セールは12/1(月)まで🎧買わないと損！🔍',
  'セールは12/1(月)まで💻色々買っておきましょ🐣',
  'セールは12/1(月)まで📐デスク環境アップデート！🪑',
  'セールは12/1(月)まで🧩買い物しないと！📅',
  'セールは12/1(月)まで🧾今のうちに！💼',
  'セールは12/1(月)まで🌙アイテム探し🔦',
  'セールは12/1(月)まで🧪自分へのご褒美！🔭',
  'セールは12/1(月)まで🏠色々整えましょ🏔️',
  'セールは12/1(月)まで📊安いときに買いましょ📈',
  'セールは12/1(月)まで🧱一年で一番安い📘',
  'セールは12/1(月)まで🎯買い物チャンス🎯',
  'セールは12/1(月)まで🧰一気に揃えましょ🧲',
  'セールは12/1(月)まで🚀🌟',
];
