...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const titleCandidates = [
      '🉐 アマゾン ブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ別まとめ',
      '🎁 アマゾン ブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ毎にチェック',
      '📝 アマゾン ブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ別お得情報',
      '✨ アマゾン ブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ毎リンク集',
      '🛍️ アマゾン ブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ別セール情報',
      '💰 アマゾン ブラックフライデー（アフターセール）セール商品情報一覧　カテゴリ毎お得商品',
    ];
    const title = titleCandidates[Math.floor(Math.random() * titleCandidates.length)];

    // 導入文（セール商品まとめ用）
    const intro = [
      'Amazonブラックフライデー（アフターセール）セール商品をカテゴリ別に整理しました。',
      '',
      '🉐 Amazonブラックフライデー（アフターセール）セール商品まとめ',
      '',
      '特別価格商品をカテゴリ別にまとめています。',
      '各カテゴリのアイテムをぜひ買い物にお役立てください。',
      '',
    ...
    const closing = [
      ...
      '引き続き、実用的な情報を発信していきますので、スキ・フォローをお願いいたします。',
      '',
