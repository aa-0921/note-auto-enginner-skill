...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const titleCandidates = [
      '🉐 アマゾン ブラックフライデーセール商品情報一覧　カテゴリ別まとめ',
      '🎁 アマゾン ブラックフライデーセール商品情報一覧　カテゴリ毎にチェック',
      '📝 アマゾン ブラックフライデーセール商品情報一覧　カテゴリ別お得情報',
      '✨ アマゾン ブラックフライデーセール商品情報一覧　カテゴリ毎リンク集',
      '🛍️ アマゾン ブラックフライデーセール商品情報一覧　カテゴリ別セール情報',
      '💰 アマゾン ブラックフライデーセール商品情報一覧　カテゴリ毎お得商品',
    ];
    const title = titleCandidates[Math.floor(Math.random() * titleCandidates.length)];

    // 導入文（セール商品まとめ用）
    const intro = [
      'Amazonブラックフライデーセール商品をカテゴリ別に整理しました。',
      '',
