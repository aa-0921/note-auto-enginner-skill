...
// -------------------------------------------------------------- 
    ...
    // 記事の「切り口・フォーマット」。ここを変えると「どんな角度で書くか」が変わる。（エンジニア向けに更新）
...
// --------------------------------
      ...
      '自身の経験談で背中を押す',
      // ーーーーーーーーーーーーーーーーーーーーーーーーーーー
      // エンジニア・キャリアカテゴリに合わせた切り口（20件）
      'なぜか〇〇になる人の共通点',
      'たった1つで変わる〇〇',
      '〇〇が教えてくれなかった本当のこと',
      '転職エージェントが「やめとけ」と言う〇〇',
      '〇〇する人としない人の決定的な違い',
      '〇〇でキャリアが変わった話',
      '知らないと損する〇〇の話',
      '〇〇した人だけが年収が上がる',
    ...
    const articleConditionsLines = [
      ...
      'タイトルは1行目に「# [実際のタイトル] | エンジニア | Web | 開発 | フォロバ | フォロバ100 」として記載してください。',
