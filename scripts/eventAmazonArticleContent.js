...
export const eventAmazonArticleSections = [
  {
    title: '## 🚀 Amazonブラックフライデー 2025：今年最後のビッグチャンスを逃すな',
    text: `⚡ 最大級のショッピングフェスティバルが、ついに開始します！

年に一度のAmazon「ブラックフライデー」が今年も開催されました。欲しかったあの商品、日頃からチェックしていたアイテムを手に入れる、2025年最後のビッグチャンスです。

このセールは単に安いだけではありません。誰もが知るAmazonデバイスから、日々の生活を効率化する家電製品、最新のファッションアイテム、そして年末年始に備えた食料品や日用品まで、あらゆるカテゴリが史上最大の割引率で登場します。`,
  },
  {
    title: '## 📅 セール期間を確認！先行セールで先手必勝のチャンス',
    text: `今回のブラックフライデーは、二段階構成となっています。特に人気のアイテムは先行セールで売り切れる可能性もあるため、スケジュールをしっかり確認し、最適なタイミングを逃さないようにしてください。
