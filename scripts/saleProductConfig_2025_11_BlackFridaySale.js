...
export const saleProductLinks = {
  ...
  '食品・飲料': [
    // 商品1: 大阪王将 肉餃子 50個入×3（合計150個）
    {
      ...
      text: [
        '🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟',
        '実際に購入して使ってみた感想です。',
        '大阪王将の味がしっかり再現されていて、値段相応の美味しさがあります。',
        '150個入りという大容量で、たれも18袋付いているので、しばらくは買い足す必要がありません。',
        'フライパンで焼くだけで本格的な餃子が作れるので、調理も簡単です。',
        '冷凍保存が効くので、食べたい時にすぐに調理できて便利です。',
        '業務用サイズなので、家族や友人が集まった時にも重宝します。',
        'おかずとしても、おつまみとしても使えるので、用途が広いです。',
        '🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟　✨　🥟',
      ].join('\n'),
    ...
    // 商品2: カップヌードル レギュラー 20個
    {
      ...
      text: [
        '🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜',
        '定番商品として長年愛用しています。',
        '安定した味で、何度食べても飽きない美味しさがあります。',
        'スープが濃厚で、麺の量と質も満足できるレベルです。',
        '容器の形状が良く、持ちやすく食べやすいので、どこでも手軽に食べられます。',
        '20個入りなので、備蓄用としても日常使いとしても重宝します。',
        'キャンプやアウトドアにも適していて、災害時の備蓄にもなります。',
        'お湯を注ぐだけで食べられるので、忙しい時や夜食にも最適です。',
        '具材も充実していて、味付豚ミンチ、エビ、スクランブルエッグなどが入っています。',
        '🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜　✨　🍜',
      ].join('\n'),
    ...
    // 商品3: 松屋 牛めしの具 30食
    {
      ...
      text: [
        ...
        'コストパフォーマンスが高く、毎日の食事に便利です。',
        '30食入りなので、しばらくは買い足す必要がなくて助かります。',
        '冷凍保存が効くので、いつでも食べたい時に食べられます。',
    ...
    // 商品4: スーパードライ アサヒ ビール 350ml×24本
    {
      ...
      text: [
        ...
        'スーパードライの味が特に良く、のど越しやキレの良さが最高です。',
        'セール時にまとめ買いすることで、お得に飲めます。',
        '24本入りで、家族や友人が集まった時にも重宝します。',
        '価格が安いことも魅力で、コストパフォーマンスが良いので、よく購入しています。',
        '辛口<生>で、キレの良い味わいが楽しめます。',
    ...
    // 商品5: 一番搾り キリン ビール350ml×24本
    {
      ...
      text: [
        '🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺',
        '定番のキリン一番搾りとして長年愛用しています。',
        '安定した美味しさで、飲みやすさも高く、毎日飲んでも飽きません。',
        'セール時にまとめ買いすることで、お得に飲めます。',
        '丁度良い量で、どんな食事にも合わせやすいです。',
        '24本入りで、家族や友人が集まった時にも重宝します。',
        '価格も手頃で、コストパフォーマンスが良いので、よく購入しています。',
        '生ビールで、キレの良い味わいが楽しめます。',
        '冷蔵庫に常備しておくと、いつでも飲めて便利です。',
        '🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺　✨　🍺',
      ].join('\n'),
    ...
    // 商品6: KIRIN本搾り チューハイ350ml×24本 グレープフルーツ
    {
      ...
      text: [
        ...
        '果実感たっぷりで安定した美味しさがあり、毎日飲んでも飽きません。',
        'ウォッカベースで程よいアルコールレベルなので、飲みやすくて重宝しています。',
        '24本入りで、家族や友人が集まった時にも重宝します。',
        'コストパフォーマンスが良いので、よく購入しています。',
        '冷蔵庫に常備しておくと、いつでも飲めて便利です。',
        '🍹　✨　🍹　✨　🍹　✨　🍹　✨　🍹　✨　🍹　✨　🍹　✨　🍹',
      ].join('\n'),
  ...
  'バッグ・スーツケース': [
    // 商品1: New Trip スーツケース Mサイズ
    {
      ...
      text: [
        '🧳　✨　🧳　✨　🧳　✨　🧳　✨　🧳　✨　🧳　✨　🧳　✨　🧳',
        'Amazonベストセラー1位ということで購入してみました。',
        '軽量で丈夫で収納力抜群で、コストパフォーマンスが良いので、買って良かったです。',
  ...
  'ドラッグストア': [
    ...
    // 商品2: エペイオス 電動歯ブラシ
    {
      ...
      text: [
        '🪥　✨　🪥　✨　🪥　✨　🪥　✨　🪥　✨　🪥　✨　🪥　✨　🪥',
        '「家電批評」で四年連続ベストバイ一位を受賞しているということで購入してみました。',
    ...
    // 商品3: ブラウン モバイルシェーバー Braun mini
    {
      ...
      text: [
        '✂️　✨　✂️　✨　✂️　✨　✂️　✨　✂️　✨　✂️　✨　✂️　✨　✂️',
        '「家電批評」の小型シェーバーおすすめランキング1位でベストバイを受賞しているということで購入してみました。',
        ...
        '丸ごと水洗いできるので、お風呂や洗面台、外出先でも簡単メンテナンスができます。',
    ...
    // 商品4: ブラウン 電気シェーバー シリーズ9 SPORT 9360cc
    {
      ...
      text: [
        '✂️　⚡　✂️　⚡　✂️　⚡　✂️　⚡　✂️　⚡　✂️　⚡　✂️　⚡　✂️',
        '友人が購入して使っているのを見て、良いと思い購入してみました。',
        ...
        'シェーバーケースも付いているので、旅行や出張の時にも持ち運びやすくて助かります。',
  ...
  'ホーム&キッチン': [
    ...
    // 商品7: シャープ ウォーターオーブン ヘルシオ AX-LSX3A-T
    {
      ...
      text: [
        ...
        '今のレンジは非常に便利でビックリします。ボタン一つで色々出来るという感じです。',
        '庫内の掃除も簡単で大満足です。',
    ...
    // 商品8: ヒツジのいらない枕 テンセル枕カバー付
    {
      ...
      text: [
        '🛏️　✨　🛏️　✨　🛏️　✨　🛏️　✨　🛏️　✨　🛏️　✨　🛏️　✨　🛏️',
        'Amazon枕ランキング1位ということで試しに買ってみました。',
    ...
    // 商品11: De'Longhi マルチダイナミックヒーター MDHU15-BK
    {
      ...
      text: [
        ...
        '静音性と安全性についても非常に信頼できて、ゼロ風暖房なので、風が当たらず快適です。',
    ...
    // 商品12: ティファール 取っ手のとれる 鍋 フライパンセット 9点セット
    {
      ...
      text: [
        '🍳　✨　🍳　✨　🍳　✨　🍳　✨　🍳　✨　🍳　✨　🍳　✨　🍳',
        '有名な「取っ手のとれる」シリーズということで購入してみました。',
  ...
  'パソコン・周辺機器': [
    ...
    // 商品12: Anker Prime Wall Charger (67W, 3 ports, GaN)
    {
      ...
      text: [
        '🔌　⚡　🔌　⚡　🔌　⚡　🔌　⚡　🔌　⚡　🔌　⚡　🔌　⚡　🔌',
        '実際に購入して使ってみた感想です。',
        '充電器のサイズと性能を高く評価できて、本当に買って良かったです。',
