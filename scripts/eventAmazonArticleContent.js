...
export const eventAmazonArticleTitles = [
  ...
  '💻 Amazonブラックフライデーセール情報を公開します',
  '⚡ 期間限定の特別価格！ブラックフライデーセールを見逃すな',
  '🔧 Amazonブラックフライデーセール情報まとめ',
  '📦 Amazonブラックフライデーセールでお得な情報を提供',
  '🎯 Amazonブラックフライデーセールで効率的にお買い物',
  '⚙️ Amazonブラックフライデーセール情報',
  '🔥 Amazonブラックフライデーセール開催！要チェック商品リスト',
];
...
export const eventAmazonArticleHeaderSections = [
  {
    title: '## 🚀 Amazonセール開催中！',
    text: `Amazonで開催中のセール情報をお知らせします💻
お得な商品を確認して、必要なアイテムを見つけてください⚡
期間限定の特別価格なので、見逃さないよう注意してください💰
...
export const eventAmazonArticleSections = [
  {
    title: '## 💖 Amazonブラックフライデー：賢く心豊かに！年末の買い物がもたらす最高の恩恵',
    text: `✨ 買うことは未来の自分への投資です

年に一度のAmazon「ブラックフライデー」は、単なる安売りイベントではございません。これは、あなたの年末の生活、そして新しい年をより豊かにするための、戦略的な機会なのです。

なぜ、この時期に買い物をするべきなのか。その経済的・心理的なメリットをご紹介いたします。`,
  },
  {
    title: '## 💰 知的な節約術！「賢い先回り買い」のメリット',
    text: `ブラックフライデーの最大の魅力は、その圧倒的な割引率にあります。
...
ブラックフライデーを利用して、心を潤す「最高のご褒美」を手に入れましょう。`,
  },
  {
...
賢く節約し、心を満たす。 Amazonブラックフライデーで、最高の年末をデザインしてください。`,
  },
  {
    title: '## 💡 なぜ今買うべき？ブラックフライデーのメリットを解説',
    text: `### Amazonデバイスが超お得！

Fire TV StickやKindle、Echoシリーズなど、Amazon純正デバイスはブラックフライデーの目玉商品です。スマートライフへの第一歩を、驚きの価格で始められます。`,
  },
  {
    title: '## 🏠 効率的に年越し準備を！',
