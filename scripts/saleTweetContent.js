...
export const saleTweetMessages = [
  ...
  '1年で最も安くなるから、ブラックフライデー（アフターセール）だけは買っちゃいます😅\n\nAmazonブラックフライデー（アフターセール）セール開催中です！',
  'この時期だけは我慢できずに買い物してしまいます...\n\nAmazonブラックフライデー（アフターセール）セール始まりました🎉',
  '普段は我慢してるけど、ブラックフライデー（アフターセール）だけは買ってしまいます😊\n\nAmazonブラックフライデー（アフターセール）セール開催中🔥',
  'また買っちゃいます...毎年同じパターン😭\n\nAmazonブラックフライデー（アフターセール）セール開催中！',
  '普段は節約モードだけど、この時期だけは許してください💸\n\nAmazonブラックフライデー（アフターセール）セール始まりました🎊',
  'ブラックフライデー（アフターセール）だけは買い物のルールを破っちゃいます🤫\n\nAmazonブラックフライデー（アフターセール）セール開催中🔥',
